...
git clone https://github.com/troman29/vipnft-miner-gpu.git miner
cd miner
...
while true; do
 node send_multigpu.js --api tonhub --bin ./pow-miner-cuda --gpu-count $(nvidia-smi --query-gpu=name --format=csv,noheader | wc -l)
 sleep 1;
done;
EOF
